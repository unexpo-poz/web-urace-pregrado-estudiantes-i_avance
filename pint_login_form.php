...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el proceso no est&aacute; habilitado.<br><br>
		</div><br>
x001
;
}
...
<br>
			<table style="padding-left:280px;" class="normal" width="100%" border="0">
				<tr>
					<td width="100%">
						C&oacute;digo de Seguridad:&nbsp;&nbsp;<img src="odbc/img.php?size=4" height="30px" style="vertical-align: middle;">&nbsp;&nbsp;<input name="vImageCodC" size="5" tabindex="3" type="text"> 
					</td>
				<tr>
				<tr>
					<td>
